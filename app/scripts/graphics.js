...
import { SHALLOW, tiles } from './logic/tile';
import { structsClass, canBeBuild } from './logic/structure';
import { militaryUnits } from './logic/militaryUnit';
import { framework } from './graphics/framework';
import { gameplayState } from './graphics/gameplayState';
import { drawMethod as draw } from './graphics/drawMethod';
import { tilePicker as picker } from './graphics/tilePicker';
import { layerManager } from './graphics/layerManager';
import { Analytics } from './graphics/analytics';
...
export const Graphics = new framework(
  new (function () {
    ...
    this.onMouseClick = function (x, y) {
      const clickedTile = picker.byColor(x, y);
