...
import { countries } from '../../logic/country';
import { structsClass, NORTH, SOUTH, EAST, WEST } from '../../logic/structure';
import { products } from '../../logic/product';
import { TOOLS_ID, WOOD_ID, BRICKS_ID, Port } from '../../logic/gameDefinitions';
import { Building } from '../../logic/building';
import { ProductionBuilding, Farm, Workshop } from '../../logic/productionBuilding';
import { __publicBuildingsMask__ } from '../../logic/publicBuilding';
import { VERY_WEALTHY, WEALTHY, NORMAL, STARVING, VERY_STARVING } from '../../logic/houseGroup';
import { OUTPUT, INPUT_1, INPUT_2 } from '../../logic/storage';
...
app.directive('buildingExtInfDescription', function () {
  return {
    template: buildingExtendedInfoDescriptionTemplate,
  };
});

app.directive('buildingExtInfFull', function () {
  return {
    template: buildingExtendedInfoFullTemplate,
  };
});
